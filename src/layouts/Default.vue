<template>
  <div>
    <div class="container navbar-container">
      <header class="navbar" x-data="{isMenuOpen: false}">
        ...
        <button class="menu-toggler" x-on:click="isMenuOpen=!isMenuOpen" title="Toggle Menu">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
            class="w-6 h-6">
            <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 9h16.5m-16.5 6.75h16.5" />
          </svg>
        </button>
        <nav class="menu" x-bind:class="{'active': isMenuOpen}">
          <ul class="menu-items">
            <li>
            ...
            <li>
              <a class="menu-item" href="#latest-work">
                Work
              </a>
            </li>
            <li>
              <a class="menu-item" href="#main-footer">
                Contact
              </a>
            </li>
          </ul>
        ...
        <section class="footer-body">
          <div>
            <p class="footer-paragraph">
              Ready to bring your ideas to life? I'm passionate about turning concepts into reality. Whether you need a
              dynamic website, a robust backend, or a captivating user interface, let's collaborate to create something
              exceptional.
            </p>
            <ul class="footer-links">
              <li>
                <a class="footer-link" href="https://github.com/mehdilight" title="Github Link">
              ...
              <li>
                <a class="footer-link" href="https://twitter.com/mehdiislight" title="X link">
              ...
              <li>
                <a class="footer-link" href="https://www.facebook.com/mehdi.elfatihi.73/" title="Facebook link">
                  <svg xmlns="http://www.w3.org/2000/svg" height="16" width="16" viewBox="0 0 512 512">
                    <path
